  ...
  return (
    <div className="min-h-full bg-canvas">
      ...
      <main className="px-4 py-5 max-w-lg mx-auto pb-24">
        ...
        {/* Timeline — flat list, flag on every card; the current stop is the
            gold sticker of the album. */}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-display uppercase text-title-lg leading-tight truncate text-ink">
                      {stop.name}
                    </span>
                  </div>
