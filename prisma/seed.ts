...
const STOPS: StopInput[] = [
  {
    ...
    latitude: 51.5074, longitude: -0.1278, currencyCode: "GBP", tempRange: "15-23°C",
  },
  {
  ...
  },
  {
    ...
    arrivalDate: "2026-08-18", departureDate: "2026-08-20", nights: 2, datesFixed: true,
    latitude: 56.8198, longitude: -5.1116, currencyCode: "GBP", tempRange: "10-18°C",
  },
  {
    order: 5, country: "Reino Unido", countryFlag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", name: "Portree", slug: "portree",
    category: "Naturaleza", priceLevel: "$$",
    arrivalDate: "2026-08-20", departureDate: "2026-08-22", nights: 2, datesFixed: true,
    latitude: 57.4125, longitude: -6.1960, currencyCode: "GBP", tempRange: "11-15°C",
  },
  {
    order: 6, country: "Reino Unido", countryFlag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", name: "Inverness", slug: "inverness",
    category: "Ciudad/Naturaleza", priceLevel: "$$",
    arrivalDate: "2026-08-22", departureDate: "2026-08-24", nights: 2, datesFixed: true,
    latitude: 57.4778, longitude: -4.2247, currencyCode: "GBP", tempRange: "11-19°C",
  },
  {
    order: 7, country: "Reino Unido", countryFlag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", name: "Edimburgo (tránsito)", slug: "edimburgo-2",
    category: "Ciudad", priceLevel: "$$",
    arrivalDate: "2026-08-24", departureDate: "2026-08-25", nights: 1, datesFixed: true,
    latitude: 55.95206, longitude: -3.19648, currencyCode: "GBP", tempRange: "12-19°C",
  },
  {
    ...
    latitude: 52.3676, longitude: 4.9041, currencyCode: "EUR", tempRange: "13-21°C",
  },
  {
    ...
    latitude: 48.8566, longitude: 2.3522, currencyCode: "EUR", tempRange: "16-24°C",
  },
  {
    order: 10, country: "Portugal", countryFlag: "🇵🇹", name: "Lisboa", slug: "lisboa",
    category: "Ciudad", priceLevel: "$-$$",
    arrivalDate: "2026-09-04", departureDate: "2026-09-09", nights: 5, datesFixed: true,
    latitude: 38.7223, longitude: -9.1393, currencyCode: "EUR", tempRange: "18-26°C",
  },
  {
    order: 11, country: "Portugal", countryFlag: "🇵🇹", name: "Porto", slug: "porto",
    category: "Ciudad/Costa", priceLevel: "$-$$",
    arrivalDate: "2026-09-09", departureDate: "2026-09-12", nights: 3, datesFixed: true,
    latitude: 41.1579, longitude: -8.6291, currencyCode: "EUR", tempRange: "15-24°C",
  },
  {
    ...
    latitude: 48.5734, longitude: 7.7521, currencyCode: "EUR", tempRange: "12-20°C",
  },
  {
    ...
    latitude: 48.0794, longitude: 7.3585, currencyCode: "EUR", tempRange: "12-20°C",
  },
  {
    ...
    latitude: 47.9990, longitude: 7.8421, currencyCode: "EUR", tempRange: "12-20°C",
  },
  {
    ...
    latitude: 46.6863, longitude: 7.8632, currencyCode: "CHF", tempRange: "8-16°C",
  },
  {
    order: 16, country: "Suiza", countryFlag: "🇨🇭", name: "Grindelwald", slug: "grindelwald",
    category: "Ciudad", priceLevel: "$$",
    arrivalDate: "2026-09-19", departureDate: null, nights: 0, datesFixed: false,
    latitude: 46.62396, longitude: 8.03601, currencyCode: "CHF", tempRange: "4-13°C",
    isCandidate: true,
  },
  {
    ...
    category: "Ciudad", priceLevel: "$$",
    arrivalDate: "2026-09-19", departureDate: null, nights: 0, datesFixed: false,
    latitude: 46.59307, longitude: 7.90938, currencyCode: "CHF", tempRange: "6-15°C",
    isCandidate: true,
  },
  {
    order: 18, country: "Austria", countryFlag: "🇦🇹", name: "Innsbruck", slug: "innsbruck",
    category: "Tránsito", priceLevel: "$$$",
    arrivalDate: "2026-09-23", departureDate: null, nights: 0, datesFixed: false,
    latitude: 47.2692, longitude: 11.4041, currencyCode: "EUR", tempRange: "7-17°C",
    isTransit: true, isCandidate: true,
  },
  {
    ...
    latitude: 48.2082, longitude: 16.3738, currencyCode: "EUR", tempRange: "10-19°C",
  },
  {
    ...
    latitude: 50.0755, longitude: 14.4378, currencyCode: "CZK", tempRange: "9-18°C",
  },
  {
    ...
    latitude: 50.0647, longitude: 19.9450, currencyCode: "PLN", tempRange: "7-15°C",
  },
  {
  ...
  },
  {
    ...
    latitude: 41.9028, longitude: 12.4964, currencyCode: "EUR", tempRange: "12-20°C",
  },
  {
    ...
    latitude: 40.8518, longitude: 14.2681, currencyCode: "EUR", tempRange: "14-20°C",
  },
  {
    order: 27, country: "Italia", countryFlag: "🇮🇹", name: "Bari", slug: "bari",
    category: "Ciudad", priceLevel: "$",
    arrivalDate: null, departureDate: null, nights: 0, datesFixed: false,
    latitude: 41.1171, longitude: 16.8719, currencyCode: "EUR", tempRange: "15-21°C",
    isCandidate: true,
  },
  {
    ...
    category: "Ciudad", priceLevel: "$",
    arrivalDate: null, departureDate: null, nights: 0, datesFixed: false,
    latitude: 37.5079, longitude: 15.0830, currencyCode: "EUR", tempRange: "18-24°C",
    isCandidate: true,
  },
  {
    ...
    category: "Ciudad", priceLevel: "$",
    arrivalDate: null, departureDate: null, nights: 0, datesFixed: false,
    latitude: 38.1157, longitude: 13.3615, currencyCode: "EUR", tempRange: "18-24°C",
    isCandidate: true,
  },
  {
    ...
    latitude: 41.3851, longitude: 2.1734, currencyCode: "EUR", tempRange: "10-17°C",
  },
  {
    ...
    latitude: 40.4168, longitude: -3.7038, currencyCode: "EUR", tempRange: "5-12°C",
  },
];
